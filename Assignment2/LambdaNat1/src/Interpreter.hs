...
evalCBN (EApp e1 e2) = case (evalCBN e1) of
    ...
    e3 -> EApp e3 e2
evalCBN ENat0 = ENat0 -- Trying to perform beta-reduction on Natural Number "O" should just return Natural Number "O"
evalCBN (ENatS e) = ENatS (evalCBN e) -- Trying to perform beta-reduction on the successor of a Natural Number should move the successor outside of the beta-reduction, and attempt to perform the beta-reduction again (recursive)
----------------------------------------------------
...
subst id s ENat0 = ENat0 -- If the substitution case encounters Natural Number "O", then "O" should be substituted back into the original beta-reduction
subst id s (ENatS e3) = ENatS (subst id e2 e3) -- If the substitution case encounters a successor of a Natural Number, the successor should be moved outside of the substitution case and attempt substitution again (recursive)
----------------------------------------------------------------
